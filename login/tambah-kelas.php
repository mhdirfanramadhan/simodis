                                            ...
                                            <form action=""  method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="col-lg-9">
                                                    ...
                                                    <div class="row">
                                                            ...
                                                            <div class="col-lg-8">
                                                                <input type="text" class="form-control" name="kelas" value='' style="background-color: #F39C12; border-radius: 15px" readonly>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-lg-4">
                                                            ...
                                                            <div class="col-lg-8">
                                                                <input type="text" class="form-control" name="jurusan" value='' style="background-color: #F39C12; border-radius: 15px">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-8">
                                                                <input type="text" class="form-control" name="wali_kelas" value=''  style="background-color: #F39C12; border-radius: 15px" required>
                                                            </div>
                                                        </div>
