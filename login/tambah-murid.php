                        ...
                        <div class="col-md-8">
                            <div class="authincation-content" style="background-color:transparent;">
                                <div class="row no-gutters">
                                    <div class="col-xl-12">
                                        <div class="auth-form">
                                            <h4 class="text-center mb-4" style="margin-top:-50px";>Tambah Murid</h4>
                                            <form method="POST" action="" enctype="multipart/form-data">
                                                ...
                                                <div class="col-lg-9">
                                                    ...
                                                    <div class="row">
                                                            ...
                                                            <div class="col-lg-8">
                                                                <input type="text" class="form-control" name="username" placeholder="" style="background-color: #F39C12; border-radius: 15px" required>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-8">
                                                                <input type="text" class="form-control" name="password" placeholder="" style="background-color: #F39C12; border-radius: 15px" required>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-8">
                                                                <input type="text" class="form-control" name="nama" placeholder="" style="background-color: #F39C12; border-radius: 15px" required>
                                                            </div>
                                                        </div>   
                                                        <div class="row">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-8">
                                                                <input type="text" class="form-control" name="tempat_lahir" placeholder="" style="background-color: #F39C12; border-radius: 15px" required>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-lg-4">
