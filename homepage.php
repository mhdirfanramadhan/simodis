...
<div class="w3-top">
  <div class="w3-row w3-large w3-light-grey">
    ...
    <div class="w3-col s3">
      <a href="#plans" class="w3-button w3-block">Dashboard Monitoring Seruni</a>
    </div>
    <div class="w3-col s3">
      <a href="#about" class="w3-button w3-block">Dashboard Monitoring Dinas</a>
    </div>
    <div class="w3-col s3">
      <a href="#contact" class="w3-button w3-block">Dashboard Monitoring Orang Tua</a>
    </div>
  </div>
</div>
